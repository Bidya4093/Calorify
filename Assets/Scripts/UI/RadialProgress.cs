...
namespace MyUILibrary
{
    ...
    public class RadialProgress : VisualElement
    {
        ...
        static CustomStyleProperty<float> s_DiagramLineWidth = new CustomStyleProperty<float>("--diagram-line-width");


        Color m_TrackColor = Color.gray;
        Color m_ProgressColor = Color.red;
        private float m_DiagramLineWidth = 10.0f;
        ...
        void GenerateVisualContent(MeshGenerationContext context)
        {
            ...
            float lineWidth = m_DiagramLineWidth;

            if (customStyle.TryGetValue(s_DiagramLineWidth, out m_DiagramLineWidth))
                lineWidth = m_DiagramLineWidth;
